...
const requiredIndexes = [
  ...
  "idx_company_yearly_stats_employer_year",
  "idx_company_yearly_stats_fiscal_year",
  "idx_company_breakdown_stats_employer_kind",
  "idx_company_breakdown_stats_kind_key",
  "idx_company_wage_stats_employer",
  "idx_company_source_stats_employer",
  "idx_company_recent_h1b_samples_employer_rank",
  "idx_company_recent_h1b_samples_source_file_id",
  "idx_company_recent_h1b_samples_location_id",
  "idx_company_recent_h1b_samples_year_status",
  "idx_company_recent_h1b_samples_city_state",
  "idx_company_recent_perm_samples_employer_rank",
  "idx_company_recent_perm_samples_source_file_id",
  "idx_company_recent_perm_samples_location_id",
  "idx_company_recent_perm_samples_year_status",
  "idx_company_recent_perm_samples_city_state",
